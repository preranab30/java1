class CreatorRunner
{
	...
	{
		System.out.println("before creator");
		...
		BlackHole backhole=new BlackHole();
		BlackHole backhole1=new BlackHole();
		BlackHole backhole2=new BlackHole();
		BlackHole backhole3=new BlackHole();
		BlackHole backhole4=new BlackHole();
		...
		System.out.println("end creator");
	}
